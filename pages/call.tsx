...
export async function getStaticProps() {
  ...
  let urlSelector = '.list-simple__output'
  var count = 0;
  for(var i = 1; i < 2; i++){
...
const cardoctorConfigs = {
  project: 'cardoctor',
  url: 'http://news.cardoctor.mn/read/2549',
  itemBlockClass: '.news-show',
  replaceAllText: {
    original: '/uploads',
  ...
  itemConfig: [
    ...
    { name: 'body', class: '.news-content', callType: 'html' },
